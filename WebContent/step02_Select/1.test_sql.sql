...
create table student(
  ...
  grade number check(grade between 1 and 6), --등급(1~6사이 제약조건)
  jumin char(13) not null,  --고정길이 문자열
  birthday  date,
  tel varchar2(15),
  height  number(4),
  weight  number(3),
